...
export const Feedback = () => {
    ...
    return <form action="#" onSubmit={() => console.log(state)}>
        <div>
            <label htmlFor="name">Name</label>
            <input id="name"
                   onChange={ev => dispatch({type: 'name', payload: ev.target.value})}
                   type="text"
                   value={state.name}/>
        </div>
        <div>
            ...
            <textarea id="text"
                      onChange={ev => dispatch({type: 'text', payload: ev.target.value})}/>
        </div>
        <div>
            <label>Rating</label>
            <Rating maxRating={5}
